...
?>
	<div class="wrap">
		...
		<?php if ( is_wp_error( $info ) ) : ?>
			<?php ITUtility::show_error_message( __( 'Error: The selected input file could not be found. Please select a different file to import.', 'it-l10n-Builder' ) ); ?>
			
			<p><a href="<?php echo esc_url( $this->_parent->_self_link ); ?>"><?php _e( '&larr; Back to Import/Export Settings', 'it-l10n-Builder' ); ?></a></p>
		<?php else : ?>
