...
?>
	<p><?php _e( 'Some features run automatically when activating a Builder theme. This helps a user start using the Builder theme much more quickly. If you find yourself changing Builder themes often, you can customize this behavior in order to better meet your needs. The following options allow you to customize this behavior to your liking.', 'it-l10n-Builder' ); ?></p>
	<hr />
	
	<p><?php _e( 'In order to allow for automatic theme upgrades, Builder recommends that a child theme is created from the theme. This child theme should then be used to make modifications, leaving the parent theme able to be upgraded without loss of customizations. What would you like Builder to do in regards to the child theme when a Builder theme is activated?', 'it-l10n-Builder' ); ?></p>
	<ul class="no-bullets">
		<li><label for="activation_child_theme_setup-ask"><?php $form->add_radio( 'activation_child_theme_setup', array( 'value' => 'ask' ) ); ?> <?php _e( 'Take the user to a setup screen to ask how they want to set up the child theme, including to not use one (default)', 'it-l10n-Builder' ); ?></label></li>
<!--	<li><label for="activation_child_theme_setup-create"><?php $form->add_radio( 'activation_child_theme_setup', array( 'value' => 'create' ) ); ?> <?php _e( 'Automatically create a child theme and switch the new child theme.', 'it-l10n-Builder' ); ?></label></li>-->
		<li><label for="activation_child_theme_setup-ignore"><?php $form->add_radio( 'activation_child_theme_setup', array( 'value' => 'ignore' ) ); ?> <?php _e( 'Do nothing. In other words, do not create a child theme and do not take the user to a setup screen asking about creating a child theme.', 'it-l10n-Builder' ); ?></label></li>
	</ul>
	<br />
	
	<p><?php _e( 'Most Builder themes provide a set of Layouts and Views that set up the site in a way that matches the concept of the designer. How would you like Builder to handle these provided Layouts and Views when a theme is activated?', 'it-l10n-Builder' ); ?></p>
	<ul class="no-bullets">
		<li><label for="activation_default_layouts-ask"><?php $form->add_radio( 'activation_default_layouts', array( 'value' => 'ask' ) ); ?> <?php _e( 'Take the user to a setup screen to ask how they want to use the theme-provided Layouts and Views (default)', 'it-l10n-Builder' ); ?></label></li>
<!--	<li><label for="activation_default_layouts-use"><?php $form->add_radio( 'activation_default_layouts', array( 'value' => 'use' ) ); ?> <?php _e( 'Use the new Layouts and Views provided by the theme.', 'it-l10n-Builder' ); ?></label></li>-->
		<li><label for="activation_default_layouts-ignore"><?php $form->add_radio( 'activation_default_layouts', array( 'value' => 'ignore' ) ); ?> <?php _e( 'Do nothing. In other words, do not add the theme-provided Layouts and Views.', 'it-l10n-Builder' ); ?></label></li>
	</ul>
<?php
