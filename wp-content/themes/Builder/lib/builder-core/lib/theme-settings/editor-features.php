...
if ( ! is_multisite() || is_super_admin() )
	builder_add_settings_tab( __( 'Setup', 'it-l10n-Builder' ), 'setup', 'ITThemeSettingsTabSetup', dirname( __FILE__ ) . '/tab-setup.php' );
...
//	builder_add_settings_editor_box( __( 'Theme Activation', 'it-l10n-Builder' ), null, array( 'var' => 'activation', '_builtin' => true, 'priority' => 'low' ) );
