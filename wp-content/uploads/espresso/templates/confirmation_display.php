...
?>
		...
		<p class="espresso_confirm_registration">
			<input class="btn_event_form_submit ui-priority-primary ui-widget-content ui-corner-all" type="submit" name="confirm" id="confirm" value="<?php _e('Confirm and Pay', 'event_espresso'); ?>&nbsp;&raquo;" />
		</p>
		...
		<div id="additional-conf-info" class="event-display-boxes">
			...
			<p class="espresso_confirm_registration">
				<input class="btn_event_form_submit ui-priority-primary ui-widget-content ui-corner-all" type="submit" name="confirm2" id="confirm2" value="<?php _e('Confirm and Pay', 'event_espresso'); ?>&nbsp;&raquo;" />
			</p>
