...
?>
	...
	<?php endif; ?>
					<?php echo ' - Add to calendar: '; echo apply_filters('filter_hook_espresso_display_ical', $all_meta); ?>
				</p>
	<?php
				}
	...
	?>
		<!-- 38solutions -->
		<p class="available_spaces">Available Spaces: <?php echo do_shortcode('[ATTENDEE_NUMBERS event_id="'.$event_id.'" type="available_spaces"]');?></p>
		<!-- 38solutions -->
	...
	?>
						<p><em> * Please do not add more attendees if using a voucher code or gift certificate.</em></p>  <!-- 38solutions - Ticket #151 -->
	<?php
