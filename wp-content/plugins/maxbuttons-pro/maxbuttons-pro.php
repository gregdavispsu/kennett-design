...
function mbpro_set_global_paths() {
	...
	define('MAXBUTTONS_PRO_VERSION_NUM', '2.5.2');
...
function mbpro_admin_menu() {
	...
	$submenu_page_title = __('MaxButtons Pro : Settings', 'maxbuttons-pro');
	$submenu_title = __('Settings', 'maxbuttons-pro');
	$submenu_slug = 'maxbuttons-settings';
	$submenu_function = 'mbpro_settings';
	$admin_pages[] = add_submenu_page($menu_slug, $submenu_page_title, $submenu_title, $capability, $submenu_slug, $submenu_function);
...
function mbpro_settings() {
	include_once 'maxbuttons-settings.php';
}
...
add_action('media_buttons_context', 'mbpro_media_button');
function mbpro_media_button($context) {
	global $pagenow, $wp_version;
	$output = '';

	// Only run in post/page creation and edit screens
	if (in_array($pagenow, array('post.php', 'page.php', 'post-new.php', 'post-edit.php'))) {
		$title = __('Add Button', 'maxbuttons-pro');
		$icon = MAXBUTTONS_PRO_PLUGIN_URL . '/images/mb-16.png';
...
add_action('admin_footer', 'mbpro_media_button_admin_footer');
function mbpro_media_button_admin_footer() {
	require_once 'maxbuttons-media-button.php';
}
