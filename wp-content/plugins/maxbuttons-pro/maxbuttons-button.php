	...
	function showColorPickerForButtonGradientStartColor() {
		...
		jQuery('#<?php echo $maxbutton_gradient_start_color_key ?>_box span').ColorPicker({
			...
			'onChange': function(hsb, hex, rgb) {
				...
				var style = jQuery("#button-result .button-output").attr("style");
				...
				style += " behavior: url('<?php echo MAXBUTTONS_PRO_PLUGIN_URL ?>/pie/PIE.htc');";
				jQuery("#button-result .button-output").attr("style", style);
	...
	function showColorPickerForButtonGradientStartHoverColor() {
		...
		jQuery('#<?php echo $maxbutton_gradient_start_color_hover_key ?>_box span').ColorPicker({
			...
			'onChange': function(hsb, hex, rgb) {
				...
				var style = jQuery("#button-result-hover .button-output").attr("style");
				...
				style += " position: relative;";
				style += " behavior: url('<?php echo MAXBUTTONS_PRO_PLUGIN_URL ?>/pie/PIE.htc');";
				jQuery("#button-result-hover .button-output").attr("style", style);
	...
	<div class="wrap">
		...
		<form id="new-button-form" method="post">
			<div class="form-actions">
				...
				<a id="button-copy" class="button" href="<?php admin_url() ?>admin.php?page=maxbuttons-controller&action=copy&id=<?php echo $button_id ?>"><?php _e('Copy', 'maxbuttons-pro') ?></a>
				<a id="button-trash" class="button" href="<?php admin_url() ?>admin.php?page=maxbuttons-controller&action=trash&id=<?php echo $button_id ?>"><?php _e('Move to Trash', 'maxbuttons-pro') ?></a>
				<a id="button-delete" class="button" href="<?php admin_url() ?>admin.php?page=maxbuttons-controller&action=delete&id=<?php echo $button_id ?>"><?php _e('Delete Permanently', 'maxbuttons-pro') ?></a>
			</div>
			...
			<div class="option-container">
				...
				<div class="inside">
					<div class="option-design">
						<p class="note"><?php _e('Adding !important to the button styles can help avoid potential conflicts with your theme styles.', 'maxbuttons-pro') ?></p>
						<div class="label"><?php _e('Use !important', 'maxbuttons-pro') ?></div>
					...
					<div class="option-design">
						...
						<div class="label"><?php _e('Use External CSS', 'maxbuttons-pro') ?></div>
					...
					<div class="option-design">
						<div class="label">&nbsp;</div>
						<div class="input"><a id="view_css_modal" name="view_css" href="#view_css" class="button" rel="leanModal"><?php _e('View CSS', 'maxbuttons-pro') ?></a></div>
						<div class="clear"></div>
