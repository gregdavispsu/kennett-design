...
define( 'SOLILOQUY_LIGHTBOX_PLUGIN_VERSION', '2.2.0' );
...
function soliloquy_lightbox_attr( $attr, $id, $item, $data, $i ) {
    ...
    // If a video, make the helper an iframe.
...
function soliloquy_lightbox_js( $data ) {
    ...
    $(document).off('click.soliloquyYouTube<?php echo $data['id']; ?> click.soliloquyVimeo<?php echo $data['id']; ?> click.soliloquyWistia<?php echo $data['id']; ?>');
    <?php endif; ?>
